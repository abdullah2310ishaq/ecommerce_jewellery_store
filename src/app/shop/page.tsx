...
import { Search, Filter, ChevronDown, Star, Grid3X3, List, Heart } from 'lucide-react';
...
const CollectionsPage = () => {
  ...
  const collections = [
    {
      ...
      longDescription: "Inspired by the night sky, each piece captures the ethereal beauty of the cosmos. Features rare blue and white diamonds set in innovative floating designs.",
    ...
    },
    {
      ...
      longDescription: "Each piece tells a story of ancient craftsmanship reimagined for modern royalty. Featuring intricate filigree work and rare colored diamonds.",
    ...
    },
    {
      ...
      longDescription: "Minimalist elegance meets maximum impact in this modern collection. Each piece showcases the unique properties of platinum.",
    ...
    },
    {
      ...
      longDescription: "South Sea and Tahitian pearls meet modern design sensibilities in this unique collection. Each pearl is carefully selected for its exceptional lustre.",
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-blue-400 font-light">{collection.price}</span>
            </div>
          </div>
        ...
        <div className="flex-1 py-8 pr-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                <span className="text-gray-300">{collection.rating} ({collection.reviews} reviews)</span>
              </div>
              <span className="text-blue-400 font-light">{collection.price}</span>
            </div>
            <button 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-blue-900/20 to-black text-gray-100">
      ...
      {/* Filters Panel */}
      <div className={`bg-gray-900/80 backdrop-blur-md border-b border-gray-800 transition-all duration-300 ${showFilters ? 'max-h-96 py-6' : 'max-h-0 overflow-hidden'}`}>
      ...
      {/* Newsletter Section */}
        ...
        <p className="text-xl mb-6">Sign up for our newsletter to receive exclusive offers and early access to new collections.</p>
