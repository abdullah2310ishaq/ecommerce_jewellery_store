...
const Footer = () => {
  return (
    <footer className="bg-[#faf6f2] dark:bg-[#1c1c1c] text-[#3d3d3d] dark:text-[#f0e6d2] py-12 px-6 md:px-16 lg:px-32">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
        ...
        <div className="flex flex-col items-center md:items-start">
          <Link href="/" className="flex items-center gap-4">
            <Image src="/logo.png" alt="Jewelry Store Logo" width={150} height={150} />
            <h1 className="text-3xl font-semibold tracking-wide">H&H Jewellery</h1>
          </Link>
        ...
        <div className="flex flex-col items-center md:items-start space-y-4">
          ...
          <div className="flex space-x-6 mt-3">
            <a href="https://www.instagram.com/handh_jewelry?igsh=ejY4YjI3cTllYXlw" target="_blank">
              <Image src="/instagram.png" alt="Instagram" width={32} height={32} className="hover:opacity-80 transition" />
            </a>
            <a href="https://www.facebook.com/share/1FAxWUrtwR/?mibextid=wwXIfr" target="_blank">
              <Image src="/facebook.png" alt="Facebook" width={32} height={32} className="hover:opacity-80 transition" />
            </a>
          </div>
        </div>
      </div>
      ...
      {/* Bottom Section */}
      <div className="mt-12 text-center text-sm border-t border-[#e0dcd7] dark:border-[#2a2a2a] pt-4">
